...
namespace PbvCompressor
{
    ...
    public class PbvCompressorLZW
    {
        ...
        public bool Compress(Stream input, Stream output)
        {
            Stream reader = input;
        ...
        public bool Decompress(Stream inStream, Stream outStream)
        {
            Stream reader = inStream;
            Stream writer = outStream;
